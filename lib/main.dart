...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int _currentPage = 0;
  Timer? _timer; // Timer for automatic slideshow
  ...
  final List<String> _slideImages = [
    'assets/slide1.png', // Replace with your actual image paths
    'assets/slide2.png',
    'assets/slide3.png',
    'assets/slide4.png',
    'assets/slide5.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column( // Changed to Column to include PageView
            children: [
              Expanded( // Wrap PageView in Expanded
  ...
  Widget buildSlideItem(int index) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Image.asset(_slideImages[index], height: 200), // Adjust height as needed
